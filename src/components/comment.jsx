                ...
                <div className="comments-toggle-btn-container">
                    {
                        ...
                        (<div className="comments-toggle-brn-toggle-userBtn-container">
                            <button className="comments-toggle-btn-toggleDelete" onClick={() => toggleDelete(comment.id)}><img className="comments-toggle-btn-toggleDelete-icon" alt="comment delete" src="./Interactive_comment_section-frontend_mentor/src/assets/images/icon-delete.svg"/>delete</button>
